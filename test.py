...
user1["identity"] = KeyHelper.generateIdentityKeyPair()
user1["regId"] = KeyHelper.generateRegistrationId()
user1["preKey"] = KeyHelper.generatePreKeys(1, 100)
#lastResortKey   = KeyHelper.generateLastResortKey()
user1["signedKey"] = KeyHelper.generateSignedPreKey(user1["identity"], 5)
